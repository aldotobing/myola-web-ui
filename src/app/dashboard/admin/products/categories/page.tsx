...
export default function AdminCategoriesPage() {
  ...
  const handleDelete = async (id: string) => {
    if (
      !confirm(
        "Hapus kategori ini? Produk yang menggunakan kategori ini mungkin terpengaruh.",
      )
    )
      return;
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Kelola kategori untuk produk store Anda
            </p>
          </div>
        </div>
                  ...
                  <tbody className="divide-y border-gray-100">
                    {categories.length > 0 ? (
                      ...
                      <tr>
                        ...
                        >
                          Belum ada kategori. Gunakan form di samping untuk
                          menambah.
                        </td>
                      </tr>
                    )}
