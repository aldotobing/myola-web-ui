        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              Pantau dan setujui pembayaran komisi staf sales
            </p>
          </div>
        </div>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex justify-center">
                        {comm.status === "paid" ? (
                          <span className="flex items-center gap-1 bg-green-50 text-green-600 px-3 py-1 rounded-full text-[10px] font-bold">
                            <CheckCircle2 size={12} /> PAID
                          </span>
                        ) : (
                          <span className="flex items-center gap-1 bg-orange-50 text-orange-600 px-3 py-1 rounded-full text-[10px] font-bold">
