  ...
  const statsConfig = [
    {
      ...
      value: `Rp ${Number(stats?.totalPenjualan || 0).toLocaleString("id-ID")}`,
      icon: DollarSign,
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">
              Selamat datang di pusat kendali ekosistem MyOLA
            </p>
          </div>
          ...
          {adminMenu.map((item, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest bg-gray-50 px-3 py-1 rounded-full group-hover:bg-pink-100 group-hover:text-pink-600 transition-colors">
                  {item.count}
                </span>
              </div>
