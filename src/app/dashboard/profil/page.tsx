      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            <div
              className={`border rounded-xl mb-8 px-6 py-4 flex items-center justify-between ${
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <p className="text-pink-600 font-bold text-sm uppercase">
                      Member Aktif
                    </p>
                    {membership?.expires_at &&
                      new Date(membership.expires_at).getTime() - Date.now() <
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-pink-500 focus:ring-1 focus:ring-pink-500 outline-none transition-all"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                      ...
                      <p className="mt-2 text-[10px] text-gray-400 font-medium">
                        Klik ikon mata untuk mengedit nomor KTP
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      {preview || ktpUrl ? (
                          ...
                          {showKtpImage ? (
                            <>
                              ...
                              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                <button
                                  type="button"
                                  onClick={() => setShowKtpImage(false)}
                                  className="bg-white text-gray-900 px-4 py-2 rounded-lg font-bold text-xs shadow-lg"
                                >
                                  Sembunyikan
                                </button>
                                <label
                                  htmlFor="ktp-upload"
                                  className="bg-pink-500 text-white px-4 py-2 rounded-lg font-bold text-xs shadow-lg cursor-pointer"
                                >
                                  Ganti
                                </label>
                              </div>
                            ...
                            <div className="text-center">
                              ...
                              <button
                                type="button"
                                onClick={() => setShowKtpImage(true)}
                                className="bg-pink-500 text-white px-6 py-2 rounded-lg font-bold text-xs hover:bg-pink-600 transition-all"
                              >
                                Lihat Foto
                              </button>
                            </div>
                        ...
                        <label
                          htmlFor="ktp-upload"
                          className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center hover:border-pink-500 transition-all cursor-pointer block bg-gray-50"
                        >
