...
import {
  ...
  getTransactionTitle,
  PointTransaction,
} from "@/lib/service/member/points";
          ...
          <div className="lg:col-span-3">
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="text-pink-500 border border-pink-500 px-4 py-2 rounded-xl hover:bg-pink-50 text-sm font-bold transition-all"
              >
                Tentang Poin
              </button>
            </div>
            ...
            <div className="bg-gradient-to-br from-pink-500 to-pink-700 rounded-3xl p-8 text-white mb-8 shadow-xl shadow-pink-100 relative overflow-hidden">
              <div className="relative z-10">
                <p className="text-pink-100 text-sm font-bold uppercase tracking-widest mb-2">
                  Total Saldo Anda
                </p>
                ...
                <div className="bg-white/20 backdrop-blur-md rounded-xl p-4 inline-block">
                  <p className="text-sm font-medium">
                    ✨ 1 Poin = Rp 1. Gunakan untuk belanja lebih hemat!
                  </p>
                </div>
              </div>
                ...
                {isLoading ? (
                  ...
                  <div className="space-y-4">
                    {transactions.map((t) => (
                      <div
                        key={t.id}
                        className="bg-white rounded-2xl p-6 flex justify-between items-center shadow-sm border border-gray-50 hover:border-pink-100 transition-all"
                      >
                        <div className="flex items-center gap-4">
                          <div
                            className={`p-3 rounded-xl ${t.amount > 0 ? "bg-green-50 text-green-600" : "bg-red-50 text-red-600"}`}
                          >
                            <CoinsIcon size={20} />
                          </div>
                          <div>
                  ...
                  <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-100">
                    ...
                    <p className="text-gray-500">
                      Kumpulkan poin dari setiap transaksi Anda!
                    </p>
                  </div>
                )}
              </TabsContent>
              ...
              <TabsContent value="kadaluarsa">
                <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-100">
                  <p className="text-gray-500 font-medium">
                    Belum ada poin yang akan kadaluarsa dalam waktu dekat.
                  </p>
                </div>
              </TabsContent>
            </Tabs>
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-6">
                    {pointInfo.map((info, index) => (
                      <div
                        key={index}
                        className="flex gap-6 p-4 rounded-2xl hover:bg-gray-50 transition-colors"
                      >
                  ...
                  <button
                    onClick={() => setShowModal(false)}
                    className="w-full mt-10 py-4 bg-pink-500 text-white font-bold rounded-2xl shadow-lg shadow-pink-100 hover:bg-pink-600 transition-all"
                  >
                    Saya Mengerti
                  </button>
                </div>
